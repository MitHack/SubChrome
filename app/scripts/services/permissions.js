// todo: double check https://github.com/android/platform_frameworks_base/blob/master/core/java/android/content/pm/PermissionInfo.java

app.factory('permissions', function() {
  return {
    all: function(){
      return {
"NONE": {
