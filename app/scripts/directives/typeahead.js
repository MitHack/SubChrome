app.directive('typeahead', ["$timeout", function($timeout) {
    return {
        ...
        transclude: true,
        replace: true,
        template: '<div><form><input class="form-control" placeholder="search for apps (ex: Facebook)" ng-model="term" ng-change="query()" type="text" autocomplete="off" /></form><div class="dropdown" ng-transclude></div></div>',
        scope: {
            search: "&",
            select: "&",
            items: "=",
